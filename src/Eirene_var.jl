# THIS IS A COPY OF EIRENE. Current version of Eirene (July 19, 2022) contains error when returning the boundary matrix.
# This variation of EIRENE fixes the issue. A pull request is created for Eirene.
